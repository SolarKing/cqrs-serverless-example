...
module.exports = {
  ...
  [commandTypes.UNPUBLISH_HACKATHON]: (state, payload) => {
  ...
  [commandTypes.OPEN_HACKATHON_REGISTRATION]: (state, payload) => {
    return [
      {
  ...
  [commandTypes.CLOSE_HACKATHON_REGISTRATION]: (state, payload) => {
    return [
      {
